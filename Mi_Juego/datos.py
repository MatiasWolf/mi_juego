...
lista_opcion_b = []
lista_opcion_c = []
lista_opcion_correcta = []

for diccionario in lista:
       lista_preguntas.append(diccionario['pregunta'])
       lista_opcion_a.append(diccionario['a'])
       lista_opcion_b.append(diccionario['b'])
       lista_opcion_c.append(diccionario['c'])
       lista_opcion_correcta.append(diccionario['correcta'])
